                    ...
                    <div class="col-xxl-5">
                        ...
                        <div class="text-center text-xxl-start">
                            <div class="badge bg-gradient-primary-to-secondary text-white mb-4">
                                <div class="text-uppercase">Design &middot; Development &middot; Photographer</div>
                            </div>
            ...
            <div class="row gx-5 justify-content-center">
                <div class="col-xxl-8">
                    <div class="text-center my-5">
                        ...
                        <p class="lead fw-light mb-4">Hi 👋, I'm Sinta Ezra Wati Gulo</p>
                        <p class="text-muted">Hello! I'm a computer science student at the University of Bengkulu with a
                            strong passion for design, development, and photography.</p>
                        <p class="text-muted">Currently focused on honing my skills in these areas as I explore the creative
                            and technical sides of technology.</p>
                        <p class="text-muted">I'm excited for the journey ahead in this ever-evolving field!</p>
                    </div>
                </div>
            </div>
        </div>
